...
/* These are the addresses where the PPCA0 and PPCA1 images are located.
 * NOTE: MCUBOOT_HEADER_SIZE will be 0 when secure boot is not enabled */
#define CORE0_IMAGE_ADDRESS (CYMEM_CM33_0_S_m33s_ppca0_nvm_C_S_START + MCUBOOT_HEADER_SIZE)
#define CORE1_IMAGE_ADDRESS (CYMEM_CM33_0_S_m33s_ppca1_nvm_C_S_START + MCUBOOT_HEADER_SIZE)
...
int main(void)
{
    ...
    printf("\x1b[2J\x1b[;H");
    printf("*********************************************\r\n");
    printf(" PSOC Control C3M8: Secure Boot Application  \r\n\n");
